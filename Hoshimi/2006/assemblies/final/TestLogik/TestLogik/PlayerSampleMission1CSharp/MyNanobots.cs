...
namespace MIPT
{
    ...
    [Characteristics(ContainerCapacity = 0,
       ...
       DefenseDistance = 0,
       Constitution = 20)]
    class CyclicNavigator : VG.Common.NanoExplorer
    {
        public CyclicNavigator() { }

        public int NPNumber = -1;
        public Point NPoint = new Point(-1, -1);
        private NavigationPointInfo[] NPs = null;
    ...
    class BodyGuard : NanoCollector
    {
        ...
        public bool Alarm(MyAI _player)
        {
            ...
            //Если в пределах досягаемости кто-то есть, настораживаемся
            if (_player.OtherNanoBotsInfo != null)
            {
                foreach (NanoBotInfo botEnemy in _player.OtherNanoBotsInfo)
                {
    ...
    DefenseDistance = 12,
    Constitution = 28)]
    class ForwardBodyguard : NanoCollector
    {
        public ForwardBodyguard()
        {
            registered = false;
        }
    ...
    [Characteristics(ContainerCapacity = 20,
     ...
     DefenseDistance = 12,
     Constitution = 6)]
    class CyclicDoctor : VG.Common.NanoCollector
    {
        public CyclicDoctor() { }
    ...
    [Characteristics(ContainerCapacity = 0,
       ...
       DefenseDistance = 0,
       Constitution = 10)]
    class Spy : VG.Common.NanoExplorer
    {
        public Spy() { }
